...
const activeClass = ref(
	"bg-yellow-600 bg-opacity-25 text-gray-100 border-yellow-200"
);
const inactiveClass = ref(
	"border-zinc-900 text-gray-500 hover:border-yellow-900 hover:bg-yellow-800 hover:bg-opacity-25 hover:text-zinc-100"
);
</script>
...
<template>
	<div class="flex">
		...
		<div
			...
			class="fixed inset-y-0 left-0 z-30 w-64 overflow-y-auto transition duration-300 transform bg-zinc-900 lg:translate-x-0 lg:static lg:inset-0"
		>
			<div class="flex items-center justify-center mt-8">
				<div class="flex items-center">
					<img src="../assets/images/icon.png" alt="" class="w-20 h-20" />
					<span class="mx-2 text-2xl font-semibold text-white"
						>Zadde Auto Mobil</span
					>
				</div>
			</div>
			...
			<nav class="mt-10">
				...
				>
					...
					<span class="mx-4">Penjualan</span>
				</router-link>
				...
				>
					...
					<span class="mx-4">Opsi Pembayaran</span>
				</router-link>
